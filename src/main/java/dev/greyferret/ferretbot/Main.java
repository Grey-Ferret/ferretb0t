...
import dev.greyferret.ferretbot.logic.MiscLogic;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		annotationConfigApplicationContext.register(AdventureProcessor.class);
		annotationConfigApplicationContext.register(MiscLogic.class);
		...
		annotationConfigApplicationContext.register(MiscService.class);
		annotationConfigApplicationContext.register(AdventureProcessor.class);
