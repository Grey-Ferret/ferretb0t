...
import it.greyferret.ferretbot.entity.json.account.AccountJson;
import it.greyferret.ferretbot.entity.json.loots.LootsJson;
import it.greyferret.ferretbot.entity.json.loots.Ok;
